...
![AI](https://img.shields.io/badge/AI-Voice_Assistant-000000?style=for-the-badge&logo=openai&logoColor=white)
...
*   **Database:** SQLite3 / CSV (`contacts.csv`)
*   **Core Modules:** Large Language Models (LLM), Speech Recognition, Facial Recognition
*   **IDE:** Microsoft Visual Studio Code

## 📂 Project Structure
*   `main.py` / `run.py` - The main entry points to initialize the application and GUI.
*   `engine/` - Contains the core Python backend logic (STT, TTS, Authentication, Automation).
